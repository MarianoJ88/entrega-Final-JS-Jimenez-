        ...
        .then(data => {
            ...
            data.forEach((product, index) => {
                ...
                productDiv.innerHTML = `
                    <button class="remove-button" data-id="${product.id}">
                        <img src="./img/cruz_roja.png" alt="Borrar">
                    </button>
                    <img src="${product.imagen}" alt="${product.nombre}">
                ...
                buyButton.addEventListener("click", () => {
                    ...
                    if (currentQuantity >= 1) {
                        ...
                        // Mostrar SweetAlert de que su prdocuto a sido agregado al carrito de compras exitosamente
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
                            title: '¡El producto a sido añadido al carrito!',   
                            showConfirmButton: false,
                            timer: 1000
                        });
                    }
